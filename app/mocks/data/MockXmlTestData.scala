...
object MockXmlTestData{
  private val associatedCIILDocumentLineDocument = AssociatedCIILDocumentLineDocumentXML("id")
  private val appliedCITradeAllowanceCharge = AppliedCITradeAllowanceChargeXML(chargeIndicator = false, 0, "")
  private val grossPriceProductCITradePrice = GrossPriceProductCITradePriceXML(5, appliedCITradeAllowanceCharge)
  ...
  private val specifiedCIILSupplyChainTradeDelivery = SpecifiedCIILSupplyChainTradeDeliveryXML(10, 0)
  private val applicableCITradeTax = ApplicableCITradeTaxXML("yes", 7, 0)
  ...
  private val specifiedCITradeProduct = SpecifiedCITradeProductXML("123", "", "hello", individualCITradeProductInstance, originCITradeCountry, includedCINote)
